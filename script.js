(() => {
  ...
  if (
    requestedMode === "boubhat" ||
    requestedMode === "reception"
  ) {
    mode = "reception-only";
  }
  ...
  function updateTravelPlane() {
    ...
    /*
     * Reception-only does not show
     * the New Zealand travel sequence.
     */
    if (
      mode ===
      "reception-only"
  ...
  console.log(
    "Biye:",
    "11 February 2027 · 7 PM onwards"
  );

  console.log(
    "Bou Bhat:",
    "13 February 2027 · Singhi Palace"
  );
